...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002740749892'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002744502899'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002476966921'))  
...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002721098869") # add multiple channels here, separated by single space
